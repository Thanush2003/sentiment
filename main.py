...
#Loading of data
file_path = r'C:\Users\N THANUSH\Desktop\dataset\IMDB Dataset SPANISH'
df=pd.read_csv(file_path)

#Split data
x_train, x_test, y_train, y_test = train_test_split(data['Reviews'], data['sentiment'], test_size=0.01, random_state=42)
